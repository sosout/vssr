...
export default class WebpackBaseConfig {
  ...
  getFileName(key) {
    ...
    if (typeof fileName === 'function') {
      fileName = fileName(this.vssrEnv)
    }
    if (this.options.dev) {
  ...
  customize(config) {
    if (typeof this.options.build.extend === 'function') {
      const extendedConfig = this.options.build.extend.call(this.builder, config, this.vssrEnv)
